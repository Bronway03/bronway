...
futbol.position.z = -0.325*Math.cos(t*0.0051);
futbol.position.x = -0.325*Math.sin(t*0.0051);
futbol.rotation.y += 0.051;

cylinderp.position.z = -0.325*Math.cos(t*0.0051);
cylinderp.position.x = -0.325*Math.sin(t*0.0051);
cylinderp.rotation.y += 0.0051;

basquet.position.z = 0.325*Math.cos(t*0.0051);
basquet.position.x = 0.325*Math.sin(t*0.0051);
basquet.rotation.y += 0.051;

cylinderp2.position.z = 0.325*Math.cos(t*0.0051);
cylinderp2.position.x = 0.325*Math.sin(t*0.0051);
cylinderp2.rotation.y += 0.0051;

tenis.position.set (0,2.4,0)
tenis.rotation.y += 0.0051;
